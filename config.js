module.exports = {
  ...
  EVENTS_EXT: '/api/forensic/moraldrift_export_events/deeprows',
  CATEGORIES_EXT: '/api/forensic/moraldrift_export_categories/rows',
  NARRATIVES_EXT: '/api/forensic/moraldrift_export_narratives/rows',
  SOURCES_EXT: '/api/forensic/moraldrift_export_sources/deepids',
  FILTERS_EXT: '/api/forensic/moraldrift_export_filters/tree',
